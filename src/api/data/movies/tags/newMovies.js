...
export const newMovies = [
  {
    name: { englishname: "", name: "ده ها دلار ارزان تر" },
  ...
  {
    name: { englishname: "moonshot", name: "مهتاب" },
  ...
  {
    name: { englishname: "Scream 4", name: "کوسه 4 " },
